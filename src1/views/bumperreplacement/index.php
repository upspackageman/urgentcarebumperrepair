<head>
	...
	<script src="assets/js/bumperreplacementScroll.js"></script>
	<script src="assets/js/bumperreplacementSwiper.js"></script>
</head>
<main>
    <!-- Landing Area -->
    ...
    <div class="images">
      ...
      <div class="caption" >
         <div class="swiper-container bumperreplacement">
			...
			<div class="swiper-button-next swipeColor"></div>
		</div>
      </div>
	  <div class="caption1">
