	  ...
	  <div class="caption" style="background-image:linear-gradient(rgba(17, 17, 17, 0.2), rgba(17, 17, 17, 0.2)),url(assets/images/Services/background.jpg); background-size:cover; height:500px;">
		<div class="swiper-container lexus1  ">
		  <div class="swiper-wrapper mt-5">  
				<div class="swiper-slide" >
				  <h2 class="text ml-5 mr-5"><q>Jared came highly recommended to me by my colleague, Steve. I needed him to repair my Porsche 911 that I don't trust to just anyone.
				...
				<div class="swiper-slide" >
				  <h2 class="text ml-5 mr-5"><q>The quality of the job Jared did on my Audi is remarkable. He really paid attention to details and treated it like it was his own car. Its like the damage never happened.
